#include "io.hpp"
//    io.cpp - ostream interface for SExpr
//
...
namespace sexpr
{
    ...
    public:
        ...
        void operator () (Void)
        {
            // misleading function name - actually sets badbit
    ...
    std::ostream& operator << (std::ostream& os, const SExpr& sex)
    {
        apply(Void(), Print(&os), sex);
        return os;
    }
} // namespace sexpr
} // namespace tmwa
